...
symbols, growths, iv, prices, discounts, recommendations = [], [], [], [], [], []

print(f"{'Stock':<6} {'Est.Growth':>13} {'Intrinsic Value':>17} {'Price':>10} {'Discount':>12} {'Recommendation':>17}")
print('--------------------------------------------------------------------------------------')
...
def main(stocks):
    ...
    for stock in stocks:
        ...
        growths.append(lt_growth)
        iv.append(intrinsic_value)
        prices.append(price)
